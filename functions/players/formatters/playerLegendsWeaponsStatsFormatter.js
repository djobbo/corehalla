...
module.exports = legendsStats => {
	return new Promise((resolve, reject) => {
		const unifiedLegendsData = _.orderBy(
			_.map(
				...
				legend => {
					return {
						...
						unarmed: {
							...
							time_held:
								legend.matchtime -
									(legend.timeheldweaponone +
										legend.timeheldweapontwo) || 0,
							time_held_format: formatTime(
								legend.matchtime -
									(legend.timeheldweaponone +
							...
							computed: {
								dps: dps(
									legend.damageunarmed,
									legend.matchtime -
										(legend.timeheldweaponone +
											legend.timeheldweapontwo),
									1,
								),
								avg_damage_per_game: avg_kos_per_game(
									legend.damageunarmed,
									legend.games,
									1,
								),
								...
								avg_kos_per_game: avg_kos_per_game(
									legend.kounarmed,
									legend.games,
									1,
								),
						...
						computed: {
							...
							ttk_format: formatTime(
								ttk(legend.falls, legend.matchtime, 1),
							),
							ttf: ttk(legend.kos, legend.matchtime, 1),
							ttf_format: formatTime(
								ttk(legend.falls, legend.matchtime, 1),
							),
							...
							avg_falls_per_game: avg_kos_per_game(
								legend.falls,
								legend.games,
								1,
							),
