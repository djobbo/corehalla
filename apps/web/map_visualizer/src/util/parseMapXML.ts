...
function parsePlatform(
    ...
    const outPlatform: Platform = {
        ...
        scaleX: parseFloat(platform.getAttribute('ScaleX') ?? '1') * parseFloat(platform.getAttribute('Scale') ?? '1'),
        scaleY: parseFloat(platform.getAttribute('ScaleY') ?? '1') * parseFloat(platform.getAttribute('Scale') ?? '1'),
