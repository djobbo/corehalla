define('./workbox-ef35eb5c.js', ['exports'], function (t) {
    'use strict'
    try {
        ...
        async expireEntries(t, e) {
            const s = await this._.transaction(L, 'readwrite', (s, n) => {
                    ...
                    i.onsuccess = () => {
                        ...
                        if (s) {
                            const n = s.value
                            n.cacheName === this.P && ((t && n.timestamp < t) || (e && a >= e) ? r.push(s.value) : a++),
                                s.continue()
                        } else n(r)
                    }
                }),
    ...
    class A {
        ...
        createHandlerBoundToURL(t) {
            ...
            return (s) => (
                (s.request = new Request(t)), (s.params = p({ cacheKey: e }, s.params)), this.strategy.handle(s)
            )
        }
    }
    const S = () => (O || (O = new A()), O)
