...
import { getPlayerAliases } from "@/server/api.functions"
...
export const Searchbox = () => {
    ...
    const { data: potentialBrawlhallaIdAliases } = useQuery({
        queryKey: ["playerAliases", search],
        queryFn: () => getPlayerAliases({ data: { playerId: search } }),
