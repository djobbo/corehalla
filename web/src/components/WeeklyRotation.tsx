...
/**
 * Presentational free-legend rotation.
 *
 * The data now arrives from the index route loader (streamed with `<Await>`),
 * so the component no longer fetches on its own. Passing an empty list renders
 * the same placeholder grid the Next.js version showed while loading.
 */
export const WeeklyRotation = ({ rotation = [] }: WeeklyRotationProps) => {
    return (
