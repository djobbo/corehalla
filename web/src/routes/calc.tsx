...
export const Route = createFileRoute("/calc")({
    // No server data: the whole page is derived from local input state. It is
    // still server rendered so the tool is available before hydration.
    ssr: true,
    head: () => ({
        meta: seoTags({
            title: "Glory / ELO Reset Calculator • Corehalla",
            description:
                "Calculate your Brawlhalla end-of-season Glory and your Elo squash for the new season.",
        }),
    }),
    component: CalcPage,
})
