...
export const SectionOverallStats: React.FC<Props> = ({ playerStats }: Props) => {
    ...
    const greatestDamageValue =
        playerStats.damageDealt > playerStats.damageTaken ? playerStats.damageDealt : playerStats.damageTaken;
        ...
        <section className="section-overall">
            ...
            <div className="stats-container">
                <Card className="games-stats">
                    <div className="games-stats-container">
                        <div>
                            <h3>Games</h3>
                            <p>
                                <span className="stat stat-large">{playerStats.games}</span>
                            ...
                            <p>
                                <span className="stat">{playerStats.games - playerStats.wins}</span>
                        ...
                        <div className="games-pie-chart">
                            <PieChart
                                width="12rem"
                                height="12rem"
                                amount={(playerStats.wins / playerStats.games) * 100}
                            />
                        </div>
                    </div>
                </Card>
                <Card className="kos-stats">
                    ...
                    <div>
                        <p>
                            ...
                            <BarChart amount={(playerStats.kos / greatestKOValue) * 100} />
                        </p>
                        <p>
                            <span className="stat">{playerStats.falls}</span>
                            <span className="stat-desc"> Falls</span>
                            <BarChart amount={(playerStats.falls / greatestKOValue) * 100} />
                        </p>
                        <p>
                            <span className="stat">{playerStats.suicides}</span>
                            <span className="stat-desc"> Suicides</span>
                            <BarChart amount={(playerStats.suicides / greatestKOValue) * 100} />
                        </p>
                        <p>
                ...
                <Card className="damage-stats">
                    ...
                    <div>
                        <p>
                            <span className="stat stat-medium">{playerStats.damageDealt}</span>
                            <span className="stat-desc"> Damage Dealt</span>
                            <BarChart amount={(playerStats.damageDealt / greatestDamageValue) * 100} />
                        </p>
                        <p>
                            <span className="stat stat-medium">{playerStats.damageTaken}</span>
