...
export const SectionWeapons: React.FC<Props> = ({ weapons }) => {
			...
			{[...weapons]
				.sort((a, b) => {
					switch (sortBy) {
						case 'rating':
							return (
								sortOrder *
								(a.season.ratingAcc - b.season.ratingAcc)
							);
						case 'peak_rating':
							return (
								sortOrder *
								(a.season.peakAcc - b.season.peakAcc)
							);
						case 'timeheld':
				...
				.map((w, i) => (
					...
					>
						...
						<p>
							{w.season.bestRating} Elo ({w.season.bestRating}{' '}
							Peak)
						</p>
						<p>
							{(w.season.ratingAcc / w.legends.length).toFixed(0)}{' '}
							Average Elo (
							{(w.season.peakAcc / w.legends.length).toFixed(0)}{' '}
							Average Peak)
						</p>
						<p>
